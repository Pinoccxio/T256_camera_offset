        ...
        try:
            with keyboard.Listener(on_press=on_press) as listener:
                while True:
                    ...
                    # if self.ss == 0:
                    #     self.vis.run()
                    #     para: o3d.visualization.ViewControl = self.vis.get_view_control()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--directory", type=str, default=r"C:\Users\10658\Downloads\save_data_wipe_1-14_02", help="Directory with saved data")
